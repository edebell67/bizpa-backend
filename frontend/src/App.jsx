...
const API_BASE_URL = process.env.REACT_APP_API_URL || `https://tall-hotels-shave.loca.lt/api/v1`;
// const API_BASE_URL = process.env.REACT_APP_API_URL || `https://bizpa-app-live-ede.loca.lt/api/v1`;
    ...
    <div className="container py-4">
      ...
      <header className="d-flex justify-content-between align-items-center mb-4">
        <h1 className="fw-bold m-0 d-flex align-items-center gap-2" style={{color: 'var(--primary)', letterSpacing: '-1px'}} onClick={() => setCurrentTab('home')}>
          bizPA 
          <span className="badge bg-warning text-dark" style={{fontSize: '0.6rem'}}>v1.2.5</span>
